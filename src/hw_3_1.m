...
for k = 1:rows
    ...
    t = linspace(0, T, Fs*T)';
    harmoConfs = [1.0000    1.4572    0.9587    1.0999    0.0523    0.1099    0.3589    0.1240    0.1351    0.0643    0.0019  0.0058];
...
sound(tunes, Fs);
audiowrite('../results/3_1.wav', tunes, Fs);
